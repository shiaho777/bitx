...
def main():
    ...
    p.add_argument("--core", default=result_path('logic_core_champion'))
    ...
    p.add_argument("--out", default=result_path('logic_multi_route'))
    p.add_argument("--bundle", default=result_path('logic_multi_dual'))
